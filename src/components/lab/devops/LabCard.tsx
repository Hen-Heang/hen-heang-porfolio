...
export function LabCard({ lab }: { lab: Lab }) {
    return (
        ...
        >
            ...
            <div>
                <h3 className="mb-1.5 text-base font-semibold text-fg">{lab.title}</h3>
                <p className="text-sm leading-relaxed text-fg-secondary line-clamp-2">{lab.description}</p>
            </div>
            <div className="mt-auto flex items-center justify-between border-t border-border pt-3">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-fg-muted">{lab.steps.length} steps</span>
