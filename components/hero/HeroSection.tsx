            ...
            <div className="container mx-auto px-4 py-12 relative z-10">
                ...
                Heang
                        ...
                        >
                            ...
                            <span className="font-semibold text-slate-800 dark:text-slate-200">Spring Boot</span>,{" "}
                            <span className="font-semibold text-slate-800 dark:text-slate-200">Next.js</span>,{" "}
                            <span className="font-semibold text-slate-800 dark:text-slate-200">TypeScript</span>, and{" "}
                            <span className="font-semibold text-slate-800 dark:text-slate-200">PostgreSQL</span>. With expertise in
                            both frontend and backend development, I create seamless digital experiences.
                        </motion.p>
                            ...
                            <Card className="p-4 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:bg-white/80 dark:hover:bg-slate-800/80 transition-all duration-300">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-600 dark:text-slate-400">San Francisco, CA</p>
                                    </div>
                                </div>
                            </Card>
                            <Card className="p-4 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:bg-white/80 dark:hover:bg-slate-800/80 transition-all duration-300">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-600 dark:text-slate-400">5+ Years</p>
                                    </div>
                                </div>
                            </Card>
                            <Card className="p-4 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:bg-white/80 dark:hover:bg-slate-800/80 transition-all duration-300">
